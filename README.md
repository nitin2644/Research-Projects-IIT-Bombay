...
📍 Presented at a Research Summit during the internship

📌 Add your poster file here (recommended naming: poster.pdf or poster.png)

Example embedding (after upload):
